...
(function (FM) {
  ...
  const CATEGORY_OF = {
    ...
    lensdistort: 'distort', pixelsort: 'stylize',
  };
  ...
  FM.FX_FEATURED = ['pixelsort', 'lensdistort', 'compresscrunch', 'temporaldenoise', 'vhstape', 'dispersion', 'lightwrap', 'chromakeypro', 'timewarp', 'hslbands', 'speedlines', 'shockwave'];
