...
(function (FM) {
  ...
  const FILTERS = [
    ...
    { id: 'tropic', name: 'Tropic', section: 'vivid',
      desc: 'Greens and blues pushed hard, warm skin kept — holiday water and foliage.',
    ...
    { id: 'popsicle', name: 'Popsicle', section: 'vivid',
      desc: 'Bright, cool and pink in the highlights — a sweet-shop palette rather than a sunny one.',
    ...
    { id: 'hivis', name: 'Hi-Vis', section: 'vivid',
      desc: 'Every colour turned up as far as it will go before it breaks, with the blacks set hard.',
    ...
    { id: 'halo', name: 'Halo', section: 'glow',
      desc: 'The red-orange bleed film puts round bright lights, plus a soft wash — glow that reads as film.',
      effects: [e('halation', { amount: 1.85, threshold: 0.42, tightness: 0.3, spread: 13 }), e('softglow', { amount: 0.42, radius: 160, threshold: 40 })] },
    { id: 'moonbeam', name: 'Moonbeam', section: 'glow',
      desc: 'Cool, quiet and softly blooming — moonlight rather than lamplight.',
    ...
    { id: 'polaroid', name: 'Polaroid', section: 'retro',
      desc: 'Lifted blacks, a warm-green cast and soft corners — the instant print, a few years on.',
    ...
    { id: 'kodachrome', name: 'Kodachrome', section: 'retro',
      desc: 'Deep reds, clean blues and a little extra contrast — the slide film everyone remembers.',
    ...
    { id: 'technicolor', name: 'Technicolor', section: 'retro',
      desc: 'Three-strip colour — saturated to the point of painted, reds and cyans leading.',
    ...
    { id: 'arctic', name: 'Arctic', section: 'cinematic',
      desc: 'Cold and pale with the blacks lifted — snow light, thin air.',
    ...
    { id: 'desert', name: 'Desert', section: 'cinematic',
      desc: 'Hot yellow light against teal shadows, highlights held back, a touch of dust.',
