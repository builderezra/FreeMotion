  ...
  FM.SHAPE_POLYS = (function () {
    ...
    S.car = [
      ...
      [
        ...
        [0.0004,0.832,1],[0.0089,0.8893,1],[0.0291,0.9518,1],[0.0785,0.9922],[0.0836,0.9987,1],[0.0354,0.9524,1],
        [0.0069,0.8918,1],[0.0019,0.8251,1],[0.0211,0.761,1],[0.0619,0.708,1],[0.119,0.6732,1],[0.1848,0.661,1],
        [0.2506,0.6732,1],[0.3077,0.708,1],[0.3485,0.761,1],[0.3677,0.8251,1],[0.3627,0.8918,1],[0.3342,0.9524,1],
        [0.286,0.9987,1],[0.291,0.9987],[0.7158,0.9987],[0.7208,0.9987,1],[0.6726,0.9524,1],[0.6441,0.8918,1],
        [0.6391,0.8251,1],[0.6583,0.761,1],[0.6991,0.708,1],[0.7562,0.6732,1],[0.822,0.661,1],[0.8878,0.6732,1],
        [0.9449,0.708,1],[0.9857,0.761,1],[1.0049,0.8251,1],[0.9999,0.8918,1],[0.9714,0.9524,1],[0.9232,0.9987,1],
        [0.9793,0.9987],[0.9996,0.9362,1],[0.9996,0.7305,1],[0.9928,0.7096],[0.9548,0.7018],[0.9278,0.6393,1],
        [0.9215,0.599,1],[0.9261,0.5846],[0.9814,0.5964],[0.9856,0.5833,1],[0.9776,0.5482,1],[0.9438,0.4857,1],
        [0.8577,0.418,1],[0.7791,0.3893],[0.6533,0.1315,1],[0.5739,0.0221,1],[0.5338,0],[0.2842,0.0013]
      ...
      // Tyres (Ezra: "it's great how it is just needs tires"). The traced body has wheel ARCHES cut up
      // from the baseline but nothing in them, so it sat on air. Each wheel is a disc wound CLOCKWISE
      // like the body outer (so nonzero unions it in — overlapping the sill is harmless) plus a hub
      // wound anticlockwise to punch a hole, which is what makes a tyre read as a tyre in a single
      // flat colour. r=0.135 against a 0.106 arch half-width: big enough to fill the arch and sit on
      // the baseline, small enough to leave the arch crescent visible — at r=0.168 the arch disappears
      // and the car goes blobby.
      // front tyre
      [
        [0.1848,0.691,1],[0.1414,0.6972,1],[0.1015,0.7154,1],[0.0684,0.7441,1],[0.0447,0.781,1],[0.0324,0.8231,1],
        [0.0324,0.8669,1],[0.0447,0.909,1],[0.0684,0.9459,1],[0.1015,0.9746,1],[0.1414,0.9928,1],[0.1848,0.999,1],
        [0.2282,0.9928,1],[0.2681,0.9746,1],[0.3012,0.9459,1],[0.3249,0.909,1],[0.3372,0.8669,1],[0.3372,0.8231,1],
        [0.3249,0.781,1],[0.3012,0.7441,1],[0.2681,0.7154,1],[0.2282,0.6972,1]
      ],
      // front hub
      [
        [0.1848,0.7825,1],[0.2119,0.7887,1],[0.2337,0.806,1],[0.2457,0.8311,1],[0.2457,0.8589,1],[0.2337,0.884,1],
        [0.2119,0.9013,1],[0.1848,0.9075,1],[0.1577,0.9013,1],[0.1359,0.884,1],[0.1239,0.8589,1],[0.1239,0.8311,1],
        [0.1359,0.806,1],[0.1577,0.7887,1]
      ],
      // rear tyre
      [
        [0.822,0.691,1],[0.7786,0.6972,1],[0.7387,0.7154,1],[0.7056,0.7441,1],[0.6819,0.781,1],[0.6696,0.8231,1],
        [0.6696,0.8669,1],[0.6819,0.909,1],[0.7056,0.9459,1],[0.7387,0.9746,1],[0.7786,0.9928,1],[0.822,0.999,1],
        [0.8654,0.9928,1],[0.9053,0.9746,1],[0.9384,0.9459,1],[0.9621,0.909,1],[0.9744,0.8669,1],[0.9744,0.8231,1],
        [0.9621,0.781,1],[0.9384,0.7441,1],[0.9053,0.7154,1],[0.8654,0.6972,1]
      ],
      // rear hub
      [
        [0.822,0.7825,1],[0.8491,0.7887,1],[0.8709,0.806,1],[0.8829,0.8311,1],[0.8829,0.8589,1],[0.8709,0.884,1],
        [0.8491,0.9013,1],[0.822,0.9075,1],[0.7949,0.9013,1],[0.7731,0.884,1],[0.7611,0.8589,1],[0.7611,0.8311,1],
        [0.7731,0.806,1],[0.7949,0.7887,1]
      ],
    ];
    // ---- squircle + additions ----
