...
(function (FM) {
  ...
  FM.SHAPE_POLYS = (function () {
    ...
    S.car = [
      ...
      // front tyre
      [
        [0.1848,0.7287,1],[0.1468,0.7342,1],[0.1118,0.7501,1],[0.0828,0.7753,1],[0.062,0.8076,1],[0.0512,0.8445,1],
        [0.0512,0.8829,1],[0.062,0.9198,1],[0.0828,0.9521,1],[0.1118,0.9773,1],[0.1468,0.9932,1],[0.1848,0.9987,1],
        [0.2228,0.9932,1],[0.2578,0.9773,1],[0.2868,0.9521,1],[0.3076,0.9198,1],[0.3184,0.8829,1],[0.3184,0.8445,1],
        [0.3076,0.8076,1],[0.2868,0.7753,1],[0.2578,0.7501,1],[0.2228,0.7342,1]
      ],
      // front hub
      [
        [0.1848,0.8087,1],[0.2087,0.8141,1],[0.2278,0.8294,1],[0.2384,0.8515,1],[0.2384,0.8759,1],[0.2278,0.898,1],
        [0.2087,0.9133,1],[0.1848,0.9187,1],[0.1609,0.9133,1],[0.1418,0.898,1],[0.1312,0.8759,1],[0.1312,0.8515,1],
        [0.1418,0.8294,1],[0.1609,0.8141,1]
      ],
      // rear tyre
      [
        [0.822,0.7287,1],[0.784,0.7342,1],[0.749,0.7501,1],[0.72,0.7753,1],[0.6992,0.8076,1],[0.6884,0.8445,1],
        [0.6884,0.8829,1],[0.6992,0.9198,1],[0.72,0.9521,1],[0.749,0.9773,1],[0.784,0.9932,1],[0.822,0.9987,1],
        [0.86,0.9932,1],[0.895,0.9773,1],[0.924,0.9521,1],[0.9448,0.9198,1],[0.9556,0.8829,1],[0.9556,0.8445,1],
        [0.9448,0.8076,1],[0.924,0.7753,1],[0.895,0.7501,1],[0.86,0.7342,1]
      ],
      // rear hub
      [
        [0.822,0.8087,1],[0.8459,0.8141,1],[0.865,0.8294,1],[0.8756,0.8515,1],[0.8756,0.8759,1],[0.865,0.898,1],
        [0.8459,0.9133,1],[0.822,0.9187,1],[0.7981,0.9133,1],[0.779,0.898,1],[0.7684,0.8759,1],[0.7684,0.8515,1],
        [0.779,0.8294,1],[0.7981,0.8141,1]
      ],
    ];
    // ---- squircle + additions ----
