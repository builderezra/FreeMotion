...
| ~~**Liquid Glass**~~ **SHIPPED** | Built and live: `liquidglass` in `js/fx-registry.js:62`, rendered at `js/compositor.js:4337` (refraction + lit rim + soft specular). This row is kept only so the estimate can be checked against what it cost. |
